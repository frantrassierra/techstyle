...
<head>
  ...
  <!-- Site Metas -->
  <link rel="icon" href="<?php echo BASE_URL; ?>public/images/fevicon/fevicon.png" type="image/gif" />
  ...
  <!-- Bootstrap core CSS -->
  <link rel="stylesheet" href="<?php echo BASE_URL; ?>public/css/style.scss">
  ...
  <link rel="stylesheet" href="<?php echo BASE_URL; ?>public/catalogo.css?v=1.0">
 ...
 -->
        ...
        <div class="user_optio_box">
          <?php if (isset($_SESSION['usuario_id'])): ?>
            ...
            <a href="perfil">
              <i class="fa fa-user" aria-hidden="true"> Mi Perfil</i>
            </a>
            <a href="misPedidos">
              <i class="fa fa-user" aria-hidden="true"> Mis Pedidos</i>
            </a>
            <a href="carrito">
            <i class="fa fa-shopping-cart" aria-hidden="true"> Carrito</i>
          </a>
            <a href="logout">
