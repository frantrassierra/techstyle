...
function route($uri, $usuarioController, $productoController, $adminController, $carritoController, $contactoController)
{
    ...
    switch ($uri) {
        ...
        case 'sobrenosotros':
            ...
            case 'ayuda':
                // Si la URI es 'inicio', mostrar la página de inicio
                require_once BASE_PATH . '/app/vistas/ayuda_general.php';
                break;
                case 'manual':
                    // Si la URI es 'inicio', mostrar la página de inicio
                    require_once BASE_PATH . '/app/vistas/manual_usuario.php';
                    break;
        case 'contacta':
            // Si la URI es 'inicio', mostrar la página de inicio
        ...
        case 'direcciones':
            if (isset($_SESSION['usuario_id'])) {
                ...
                $_SESSION['error_message'] = "Debes iniciar sesión para acceder a tus direcciones.";
                header('Location: login');
            }
            break;
        ...
        case 'mostrarFormularioAddDireccion':
            if (isset($_SESSION['usuario_id'])) {
                ...
                $_SESSION['error_message'] = "Debes iniciar sesión para añadir direcciones nuevas.";
                header('Location: login');
            }
            break;
        ...
        case 'misPedidos':
            if (isset($_SESSION['usuario_id'])) {
                ...
                $_SESSION['error_message'] = "Debes iniciar sesión para acceder a ver tus pedidos.";
        ...
        default:
            ...
            require_once __DIR__ . '/../../app/vistas/404.php';
